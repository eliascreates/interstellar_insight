...
import 'package:interstellar_insight/features/characters/characters.dart'
    show Character, CharactersDetailPage;

class LocationResidentCard extends StatelessWidget {
  final Character character;

  const LocationResidentCard(this.character, {super.key});
      ...
      onTap: () => Navigator.push(
        ...
        FadePageRoute(
          page: CharactersDetailPage(
            character: character,
            widgetName: 'LocationResidentCard',
          ),
        ),
      ),
      child: Hero(
        tag: '${character.imageUrl}-LocationResidentCard',
